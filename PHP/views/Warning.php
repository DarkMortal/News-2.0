...
<html lang="en">
  ...
  <body>
    ...
    <script>
          swal({
          title: "Email or Usernme already Present",
...
<section class="text-gray-500 bg-gray-900 body-font" style="background-image: url('./Resources/Image.jpg'); background-repeat: no-repeat;">
  <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
    <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
      ...
      <p class="mb-8 leading-relaxed" align="justify" style="background: rgba(0,0,0,0.45); padding: 10px; border-radius: 10px;"><b><font color="white">BBC News is an operational business division of the British Broadcasting Corporation (BBC) responsible for the gathering and broadcasting of news and current affairs. The department is the world's largest broadcast news organisation and generates about 120 hours of radio and television output each day, as well as online news coverage. The service maintains 50 foreign news bureaux with more than 250 correspondents around the world. Fran Unsworth has been Director of News and Current Affairs since January 2018. The BBC is a quasi-autonomous corporation authorised by royal charter, making it operationally independent of the government, who have no power to appoint or dismiss its director general, and require it to report impartially. However, as with all major media outlets, it has been accused of political bias from across the political spectrum, both within the UK and abroad. The department's annual budget is in excess of £350 million.</font></b></p> 
      <div class="flex justify-center">
        <a href="https://www.facebook.com/bbcnews" target="_blank"><button class="inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg">Like our Facebook Page</button></a>
        <a href="https://www.youtube.com/user/bbcnews" target="_blank"><button class="ml-4 inline-flex text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 hover:text-white rounded text-lg">Link to our Youtube Channel</button></a>
      </div>
    </div>
...
<button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" onclick="Entertainment()">
  Entertainment
</button>
...
<section class="text-gray-400 bg-gray-900 body-font" style="background-image: url('./Resources/FooterIMG.jpg'); background-repeat: no-repeat;">
  <div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
    <div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0" style="background: rgba(0,0,0,0.45); padding: 10px; border-radius: 10px; color: white;">
      ...
      <p class="leading-relaxed mt-4"><b>Hello. My name is Saptarshi Dey and I am currently studying B.Tech Computer Science in Guru Nanak Institute of Technology 
      <br><a href="https://github.com/Saptarshi-Dey" target="_blank">GitHub</a> <a href="https://www.facebook.com/Dey.Saptarshi.Dey/" target="_blank">Facebook</a></b></p>
    </div>
    <div class="lg:w-2/6 md:w-1/2 bg-gray-800 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
      ...
      <input class="bg-gray-900 rounded border text-white border-gray-900 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 mb-4" style="width: 100%;" placeholder="Enter your Email" type="email" name="mail" required/>
      <input class="bg-gray-900 rounded border text-white border-gray-900 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 mb-4" style="width: 100%;" placeholder="Enter password" type="password" name="pass" required/>
      <input type="submit" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" style="width: 100%;" value="Sign Up"></form>
  </div>
</section>

<a class="weatherwidget-io" href="https://forecast7.com/en/22d5788d36/kolkata/" data-label_1="KOLKATA" data-label_2="WEATHER" data-theme="original" >KOLKATA WEATHER</a>
<script>
